...
router.post("/store/:store_id", authMiddleware, roleAuthMiddleware(["owner", "staff", "manager"]), createDish); 
// router.post("/store/:store_id", createDish); 



router.put("/:dish_id", authMiddleware, roleAuthMiddleware(["owner", "staff", "manager"]), updateDish); 
// router.put("/:dish_id", updateDish); 
router.delete("/:dish_id", authMiddleware, roleAuthMiddleware(["owner", "staff", "manager"]), deleteDish);
